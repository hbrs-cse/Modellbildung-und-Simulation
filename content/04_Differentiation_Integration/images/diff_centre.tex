...
%		];
		...
		\draw[blue, line width=1pt,dashed] (0.0,1) -- (0.8,1);
		\draw[blue, line width=1pt,dashed] (0.8,1) node[right] {$\Delta y$} -- (0.8,2.2255);
		\node at (0.4,1) [blue,below] {$2 \Delta x$};
		
		\draw[blue, line width=1pt,dashed] (0.0,1) node[right] {} -- (0.8,2.2255);
		\addplot[blue,samples=500,domain=-0.25:1.25,line width = 1pt] {(2.2255-1)/0.8*x+(1.4918-(2.2255-1)/0.8*0.4)};
		
		\node at (0.4,3) [blue,above] {$y'(x_i)\approx \frac{\Delta y}{2 \Delta x} = \frac{y(x_{i+1})-y(x_{i-1})}{x_{i+1} - x_{i-1}}$};
