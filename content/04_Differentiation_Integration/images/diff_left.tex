...
%		];
		...
		\draw[blue, line width=1pt,dashed] (0.0,1) -- (0.4,1);
		\draw[blue, line width=1pt,dashed] (0.4,1) node[right] {$\Delta y$} -- (0.4,1.4918);
		\node at (0.2,1) [blue,below] {$\Delta x$};
		
		\addplot[blue,samples=500,domain=-0.25:1.25,line width = 1pt] {0.4918/0.4*x+1};
		
		\node at (0.4,3) [blue,above] {$y'(x_i)\approx \frac{\Delta y}{\Delta x} = \frac{y(x_i)-y(x_{i-1})}{x_i - x_{i-1}}$};
