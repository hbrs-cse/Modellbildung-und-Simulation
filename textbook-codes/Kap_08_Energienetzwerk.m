...
%-- Plot 
 ...
 legend('U_0(t)','U_1(t)','u_B(t)','location','east'); title('Spannungen')
 xlabel('Zeit / h'); ylabel('V');
 subplot(2,2,2); plot(t,y(:,3),t,y(:,4),t,y(:,5),'linewidth',1)
 legend('i_V(t)','i_{PV}(t)','i_B(t)','location','south'); title('Stroeme')
 xlabel('Zeit / h'); ylabel('A');
 subplot(2,2,3); plot(t,y(:,7),'linewidth',1)
 legend('soc(t)','location','northwest'); title('Ladezustand')
 xlabel('Zeit / h'); 
end
